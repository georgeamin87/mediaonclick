...
export default function PortfolioDetailsPage() {
  return (
    <>
      <PageHeading 
        title='Aluha Event Management'
        bgSrc='/images/service_hero_bg.jpeg'
        pageLinkText='PORTFOLIO - Aluha'
      />
      <Spacing lg='150' md='80'/>
      <Div className="container">
        <Image src={imgUrl} alt="Aluha Case Study" placeholder="blur" className="cs-radius_15 w-100" />
        <Spacing lg='90' md='40'/>
        <Div className="row">
          <Div className="col-lg-6">
            <SectionHeading 
              title='Aluha Corporate Events' 
              subtitle='Event Management Services' 
            >
              <Spacing lg='40' md='20'/>
              <p>
                Media On Click provided comprehensive event management services for Aluha, handling all aspects from conceptualization to execution. 
                Our team delivered seamless corporate events that aligned perfectly with Aluha's brand identity and objectives.
              </p>
              <Spacing lg='10' md='10'/>
              <p>
                ...
                The result was a series of successful events that enhanced Aluha's corporate image and stakeholder engagement.
              </p>
            </SectionHeading>
          </Div>
