...
export default function ServiceDetails() {
  const details = {
    ...
    description: 'From corporate launches to immersive public activations, we design and manage events that reflect your brand\'s personality, goals, and story - executed flawlessly from start to finish. Our team handles every detail to create memorable experiences that engage your audience.',
    ...
    features: [
      ...
      'On-site execution and staff management',
      ...
      <Div className='container'>
        ...
        <Div className='row'>
          <Div className='col-lg-6'>
            ...
            <Spacing lg='50' md='30' />
            <h3 className='cs-font_30 cs-m0'>Event Types We Manage</h3>
            <Spacing lg='30' md='20' />
            <Div className='row'>
              {details.eventTypes.map((type, index) => (
                <Div key={index} className='col-xl-5 col-lg-6'>
                  <Div className='cs-event_type'>
                    <img src={type.icon} alt={type.title} style={{ width: '64px', height: '64px' }} />
                    <h4>{type.title}</h4>
                    <p>{type.desc}</p>
                  </Div>
                </Div>
          ...
          <Div className='col-xl-5 offset-xl-1 col-lg-6'>
            <h3 className='cs-font_30 cs-m0'>Our Full-Service Offerings</h3>
            <Spacing lg='30' md='20' />
